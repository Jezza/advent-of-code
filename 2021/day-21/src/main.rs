...
fn main() {
    ...
    aoc(
        part_one,
        vec![(TEST_1, 739785), (INPUT, 913560), (LE_DIRK, 504972)],
    );
    aoc(
        part_two,
        vec![
    ...
    <T as std::str::FromStr>::Err: std::fmt::Debug,
{
    ...
    (
        left[28..].parse::<T>().unwrap(),
        right[28..].parse::<T>().unwrap(),
    )
}
...
fn part_two(input: &str) -> u128 {
    ...
    fn split_universe(left: (u8, i128), right: (u8, i128)) -> (u128, u128) {
        FREQUENCIES
            ...
            .fold(
                (0, 0),
                |(left_total_wins, right_total_wins), (frequency, (right_wins, left_wins))| {
                    (
